...
```{r}
print(intersect(l.actor.fight.club, l.actor.se7en))
```
...
print(intersect(l.movie.brad.pitt, l.movie.george.clooney))
```
...
# use tail() to check if the cumsum in last row is equal to total
print(dt.movie.year)
